...
signalTemplate = (
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_bitfield"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_dist_from_path"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_dx"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_dy"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_id"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_lane_conf"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_length"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_life_time"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_motion_state"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_source"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_vx_rel"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_vy_rel"),
		("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_second_obj_width"),
)

signalTemplate2 = (
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_bitfield_value"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_dx"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_dy"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_fusion_history"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_id"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_lane"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_lane_conf"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_lat_distance_from_path"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_length"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_life_time"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_motion_state"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_predicted_lat_dist"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_source"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_vx_rel"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_vy_rel"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_second_width"),
...
def createMessageGroups(signalTemplates, signalTemplate2):
		...
		for signalTemplate in signalTemplate2:
			fullName = signalTemplate[1]
			shortName = fullName.split("second_")[-1]
			if shortName == 'id':
				shortName = 'object_id'
			if shortName == 'source':
				shortName = 'object_source'
...
class Flc25AebsSecondObjectTrack(ObjectFromMessage):
		...
		_attribs2 = tuple(tmpl[1].split("second_")[-1] for tmpl in signalTemplate2)
		...
		def __init__(self, id, time, source, group, invalid_mask, scaletime = None):
				...
				self._group = group
				super(Flc25AebsSecondObjectTrack, self).__init__(id, time, None, None, scaleTime = None)
				return
...
class Calc(iCalc):
		...
		def fill(self, groups, common_time):
				...
				for _id, group in enumerate(groups):
						...
						VALID_FLAG = True
						tracks[_id] = Flc25AebsSecondObjectTrack(_id, common_time, None, group, invalid_mask,
																										 scaletime = common_time)
				if not VALID_FLAG:
						logging.warning("Error: {} :Measurement does not contain AEBS second object data".format(self.source.FileName))
				return tracks
...
if __name__ == '__main__':
		...
		tracks = manager_modules.calc('fill_flc25_aebs_second_obj@aebs.fill', manager)
		print(tracks)
