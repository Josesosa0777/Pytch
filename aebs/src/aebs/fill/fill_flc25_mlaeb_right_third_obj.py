...
signalTemplate = (
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_bitfield_value"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_dx"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_dy"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_fusion_history"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_id"),
 ("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_lane"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_lane_conf"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_lat_distance_from_path"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_length"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_life_time"),
 ("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_motion_state"),
 ("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_predicted_lat_dist"),
 ("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_source"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_vx_rel"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_vy_rel"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_right_third_width"),
...
class Flc25MlaebRightThirdObjectTrack(ObjectFromMessage):
    _attribs = tuple(tmpl[1].split("third_")[-1] for tmpl in signalTemplate)
    ...
    def __init__(self, id, time, source, group, invalid_mask, scaletime=None):
        ...
        self._group = group
        super(Flc25MlaebRightThirdObjectTrack, self).__init__(id, time, None, None, scaleTime=None)
        return
...
class Calc(iCalc):
    ...
    def fill(self, groups, common_time):
        ...
        for _id, group in enumerate(groups):
            ...
            VALID_FLAG = True
            tracks[_id] = Flc25MlaebRightThirdObjectTrack(_id, common_time, None, group, invalid_mask,
                                                    scaletime=common_time)
        if not VALID_FLAG:
            logging.warning("Error: {} :Measurement does not contain MLAEBS right third object data".format(self.source.FileName))
        return tracks
