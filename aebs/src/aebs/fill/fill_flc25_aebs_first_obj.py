...
signalTemplate = (
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_bitfield"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_dist_from_path"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_dx"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_dy"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_id"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_lane_conf"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_length"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_life_time"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_motion_state"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_source"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_vx_rel"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_vy_rel"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_first_obj_width"),
)

signalTemplate2 = (
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_bitfield_value"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_dx"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_dy"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_fusion_history"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_id"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_lane"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_lane_conf"),
    ("MTSI_stKBFreeze_020ms_t",
     "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_lat_distance_from_path"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_length"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_life_time"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_motion_state"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_predicted_lat_dist"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_source"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_vx_rel"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_vy_rel"),
    ("MTSI_stKBFreeze_020ms_t", "MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_aebs_first_width"),
...
class Flc25AebsFirstObjectTrack(ObjectFromMessage):
    ...
    _attribs2 = tuple(tmpl[1].split("first_")[-1] for tmpl in signalTemplate2)
    ...
    def __init__(self, id, time, source, group, invalid_mask, scaletime=None):
        ...
        self._group = group
        super(Flc25AebsFirstObjectTrack, self).__init__(id, time, None, None, scaleTime=None)
        return
...
class Calc(iCalc):
    ...
    def fill(self, groups, common_time):
        ...
        for _id, group in enumerate(groups):
            ...
            VALID_FLAG = True
            tracks[_id] = Flc25AebsFirstObjectTrack(_id, common_time, None, group, invalid_mask,
                                                    scaletime=common_time)
        if not VALID_FLAG:
            logging.warning("Error: {} :Measurement does not contain AEBS first object data".format(self.source.FileName))
        return tracks
