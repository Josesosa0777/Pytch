...
signalTemplate = (
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_bitfield_value"),
 ("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_dx"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_dy"),
 ("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_fusion_history"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_id"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_lane"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_lane_conf"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_lat_distance_from_path"),
 ("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_length"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_life_time"),
 ("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_motion_state"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_predicted_lat_dist"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_source"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_vx_rel"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_vy_rel"),
("MTSI_stKBFreeze_020ms_t","MFC5xx_Device_KB_MTSI_stKBFreeze_020ms_t_flts_aebs_meas_mlaeb_left_second_width"),
)
...
class Flc25MlaebLeftSecondObjectTrack(ObjectFromMessage):
    ...
    def __init__(self, id, time, source, group, invalid_mask, scaletime=None):
        ...
        self._group = group
        super(Flc25MlaebLeftSecondObjectTrack, self).__init__(id, time, None, None, scaleTime=None)
        return
...
class Calc(iCalc):
    ...
    def fill(self, groups, common_time):
        ...
        for _id, group in enumerate(groups):
            ...
            VALID_FLAG = True
            tracks[_id] = Flc25MlaebLeftSecondObjectTrack(_id, common_time, None, group, invalid_mask,
                                                    scaletime=common_time)
        if not VALID_FLAG:
            logging.warning("Error: {} :Measurement does not contain MLAEBS left second object data".format(self.source.FileName))
        return tracks
