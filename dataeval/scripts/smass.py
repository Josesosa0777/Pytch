...
config_frame = MassFrame(config, args, use_simplified_interface=True)
config_frame.setWindowTitle('sMASS')
config_frame.start()

print >> sys.stderr, 'Please press ctrl + c in command prompt to close sMASS'
