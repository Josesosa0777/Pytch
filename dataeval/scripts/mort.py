...
from dmw.ViewConfigFrame import cViewConfigFrame
...
config_frame = cViewConfigFrame(app, config)
config_frame.setWindowTitle('mort')
config_frame.start()

config.log( 'Please press ctrl + c to close mort' )
