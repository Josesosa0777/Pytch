...
class Calc(iCalc):
  dep = namedtuple('Dep', ['aeb'])('fill_flc25_aoa_aebs_tracks@aebs.fill')
  ...
  def __call__(self, report):
    ...
    try:
        aeb = self.get_modules().fill(self.dep.aeb)[0]
    except:
    ...
    for idx, (start, end) in report.iterIntervalsWithId():
        ...
        try:
            aeb_start, end = aeb.alive_intervals.findInterval(start)
        except ValueError:
