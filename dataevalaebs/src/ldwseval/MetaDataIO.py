...
def create_dbc_list():
    ...
    pass # print "non existing dbc file: ", [ dbc for dbc in dbc_list if not os.path.exists(dbc)]
...
def create_dbc_list_MAN_GV():
    ...
    pass # print "create_dbc_list_MAN_GV", dbc_list
   
    # remove non existing dbc files
    pass # print "non existing dbc file: ", [ element for element in dbc_list if not os.path.exists(element.split(';')[1])]
    dbc_list = [ element for element in dbc_list if os.path.exists(element.split(';')[1])]
   
    dbc_list = convert_DbcList(dbc_list) 
   
    pass # print "dbc_list", dbc_list
    return dbc_list
...
class cFLC20CalibData(object):
    ...
    def __init__(self, VehicleName, verbose=False):
        ...
        if self.verbose:
            pass # print "VehicleName", VehicleName
        ...
        if self.verbose:
            pass # print "leftWheel               ",leftWheel
            pass # print "rightWheel              ",rightWheel
            pass # print "corridor_outer_boundary ", corridor_outer_boundary
            pass # print "warn_margin_left        ", warn_margin_left
            pass # print "warn_margin_right       ", warn_margin_right
            pass # print "dx_camera_to_front_axle ", dx_camera_to_front_axle
...
class cTestTrackData(object):
    ...
    def __init__(self, FullFileName, verbose=False):
        ...
        pass # print "FullFileName", FullFileName
