...
"""
:Name:
	view_paebs_kpi_for_gt_raw_with_flc25_cem_tpf_tracks.py
:Type:
	View Script
:Visualization Type:
	Plot and Table Visualization
:Full Path:
	dataevalaebs/src/dataevalaebs/view_paebs_kpi_for_gt_raw_with_flc25_cem_tpf_tracks.py
:Sensors:
	FLC25(CEM_TPF), ADMA(CAN)
:Short Description:
		Pedestrain AEBS is a crucial function and it should provide high accuracy level of detection of pedestrians.
		It is important to check accurancy of information provided by camera sensor. This information is mainly
		longitudinal distance, lateral distance, vlocity etc. For reference measurement ADMA based sensor is used
		to provide real time ground truth data.Both the sensors are used to provide this information. Information
		provided by Camera sensor and ADMA (Automotive Dynamic Motion Analyzer) sensor is later then compared for accuracy.
		This script is used to visualize difference between actual inputs from Camera sensor vs GPS based ground truth data retrived
		from ADMA.
:Large Description:
		Usage:
				- Visualization of comparision between Ground Truth and FLC25 CEM TPF data
				- To check accuracy of camera sensor
				- To analyze actual data with sensor data
				- This analysis help to improve sensor accuracy
		.. image:: ../images/view_paebs_kpi_for_gt_raw_with_flc25_cem_tpf_tracks_3.jpg
		.. image:: ../images/view_paebs_kpi_for_gt_raw_with_flc25_cem_tpf_tracks_4.png
:Dependencies:
		- fill_flc25_cem_tpf_tracks@aebs.fill
		- fill_ground_truth_raw_tracks@aebs.fill
:Output Data Image/s:
		.. image:: ../images/view_paebs_kpi_for_gt_raw_with_flc25_cem_tpf_tracks_1.png
		.. image:: ../images/view_paebs_kpi_for_gt_raw_with_flc25_cem_tpf_tracks_2.png
