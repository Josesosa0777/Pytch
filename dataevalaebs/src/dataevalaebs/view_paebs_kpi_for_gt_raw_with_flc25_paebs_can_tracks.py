...
"""
:Name:
	view_paebs_kpi_for_gt_raw_with_flc25_paebs_can_tracks.py
:Type:
	View Script
:Visualization Type:
	Plot and Table Visualization
:Full Path:
	dataevalaebs/src/dataevalaebs/view_paebs_kpi_for_gt_raw_with_flc25_paebs_can_tracks.py
:Sensors:
	FLC25(CAN), ADMA(CAN)
:Short Description:
		`More Information about ADMA, PAEBS_CAN, Usage and Output <../html/dataevalaebs.html#module-dataevalaebs.view_paebs_kpi_for_gt_raw_with_flc25_cem_tpf_tracks>`__
:Dependencies:
		- fill_flc25_paebs_can_tracks@aebs.fill
...
init_params = dict(('TRACK_%02d' % i, dict(id = i)) for i in xrange(1, 4))


class cMyView(iView):
		dep = 'fill_flc25_paebs_can_tracks@aebs.fill', 'fill_ground_truth_raw_tracks@aebs.fill'
		...
		def check(self):
				...
				flc25_tracks = modules.fill("fill_flc25_paebs_can_tracks@aebs.fill")
