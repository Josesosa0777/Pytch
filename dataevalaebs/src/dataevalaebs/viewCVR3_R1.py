'''
   ...
   - CVR3:    Position Matrix R1 (first object in same lane)
...
class cView(interface.iView):
  ...
  def view(cls, Param=DefParam):
    try:
      ...
      Client = datavis.cPlotNavigator(title="CVR3 - first right lane (R1)", figureNr=None)
      ...
      Client.addSignal2Axis(Axis, "R1", Time, Value, unit="", color='b')
