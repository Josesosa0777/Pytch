...
"""
Interactive video visualizer (VideoNavigator) with object and lane overlay
...
from view_videonav import getVideoName
from view_videonav import SignalGroups as multimedia_sgs
from view_videonav import (ENABLE_HACK_FOR_MULTIMEDIA_OFFSET,
		getManuallyCorrectedMultimedia)
...
class cView(interface.iView):
		...
		def view(self, avi_filename, vidtime_group, ldw_group):
				...
				if 'VidTime' in vidtime_group:
						...
						# vidtime = vidtime_time - vidtime_time[0]
				else:
						vidtime_time = vidtime_group.get_time('Time')
				vidtime = vidtime_time - vidtime_time[0]
