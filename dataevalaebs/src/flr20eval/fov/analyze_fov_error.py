...
class Analyze(analyze_all.Analyze):
  QUERY_PAT = """
    ...
    WHERE mo.class = "flr20eval.fov.search_fov_error.Search" OR
          mo.class = "flr20eval.fov.search_fov_count_left.Search" OR
          mo.class = "flr20eval.fov.search_fov_count_centre.Search" OR
          mo.class = "flr20eval.fov.search_fov_count_right.Search"
  """
