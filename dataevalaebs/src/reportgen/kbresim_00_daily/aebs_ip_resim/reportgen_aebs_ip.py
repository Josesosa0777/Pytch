...
class AebsAnalyze(Analyze):
    optdep = dict(
        aebs_events='analyze_aebs_ip-last_entries@reportgen.aebs_ip_resim',
...
class Flr20Summary(AebsSummary):
  ...
  """ \
    ...
    extra_modules = [
        ('view_aebs_ip_commands-AEBS_C_6_1_vs_7_0__DEV_GENERAL_8_17_BRAKING@aebseval.sim',
         Client('DriverAct_AebsOut_Plot', '640x700+0+0', 11, 12, cm)),
        ('view_aebs_ip_kinematics@aebseval.sim',
