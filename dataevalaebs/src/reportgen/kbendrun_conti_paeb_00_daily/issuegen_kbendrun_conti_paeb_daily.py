...
class Analyze(iAnalyze):
  optdep = dict(
    ...
    dur_vs_flc20status='view_quantity_vs_sensorstatus_stats-print_duration@mfc525eval.sensorstatus',
    dur_vs_aebsstate='view_quantity_vs_systemstate_stats_flr25-print_duration@aebseval.systemstate',
    dur_vs_ldwsstate='view_quantity_vs_systemstate_stats_flr25-print_duration@ldwseval.systemstate',
