...
class AebsAnalyze(Analyze):
  ...
  def fill(self):
    ...
    story = intro(
      ...
      relevant events are collected in this automatically generated report.<br/>
      Statistical results are presented first, followed by the detailed
      overview of the individual events.<br/>
      <br/>
      Remark: Object and lane information are presented based on the simultaneously
      measured Knorr-Bremse forward-looking radar (FLR21) and camera (FLC20) sensors.<br/>
      <br/>
      """
    )
