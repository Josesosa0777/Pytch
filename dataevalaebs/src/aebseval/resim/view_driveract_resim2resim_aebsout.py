...
class View(iView):
    dep = ('calc_aebs_resim2resim_output@aebs.fill')
    ...
    def check(self):
        sgs = [
            ...
            #
            {
                ...
                "aebs_state": ("AEBS1_2A_s2A", "AEBS1_AEBSState_2A"),
                "coll_warn_level": ("AEBS1_2A_s2A", "AEBS1_CollisionWarningLevel_2A"),
                "xbr_demand": ("XBR_0B_2A_d0B_s2A_XBR_0B_2A", "XBR_CtrlMode_0B_2A"),
                "xbr_ctrl_mode": ("XBR_0B_2A_d0B_s2A_XBR_0B_2A", "XBR_ExtAccelDem_0B_2A"),
            },
            {
        ...
        baseline_aebs_events, retest_aebs_events, time, total_mileage = self.modules.fill(self.dep)
        return group, baseline_aebs_events, retest_aebs_events, time

    def view(self, group, baseline_aebs_events, retest_aebs_events, time):
        ...
        if 'aebs_state' in group:
            ...
            for key, value in valid_aebs_resim_data.iteritems():
                ...
                if key == 'baseline_aebs_events':
                    axis_label = 'AEBSState baseline resim'
                else:
                    axis_label = 'AEBSState retest resim'
                ...
                for item in value:
                    ...
                    pn.addSignal2Axis(ax, axis_label, time00,np.ma.array(delta_data_array, mask=masked_aray))
