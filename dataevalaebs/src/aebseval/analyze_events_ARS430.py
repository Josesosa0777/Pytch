...
"""
Queries the AEBS events which was searched with 'ARS430 Warning' algo from the database.
...
class Analyze(analyze_all.Analyze):
  QUERY_PAT = """
    ...
    WHERE mo.class = "aebseval.search_events.Search"
    AND mo.param LIKE "%%ARS430 Warning%%" AND
          NOT EXISTS (
