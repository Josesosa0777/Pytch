...
sgs  = [
{
  ...
  "AEB_TargetTimer": ("ACC_S08", "AEB_TargetTimer"),
...
class View(interface.iView):
  ...
  def view(self, param, group):
    ...
    time09, value09, unit09 = group.get_signal_with_unit("AEB_TargetTimer")
    client00.addSignal2Axis(axis05, "AEB_TargetTimer", time09, value09, unit=unit09)
    return
