...
class View(iView):
		...
		def view(self, t, CAN_signals, ABDLaneData_signals):
				...
				diff_0 = ABDLaneData_signals.left_left_line.c0 - CAN_signals.left_left_line.c0
				pn.addSignal2Axis(ax, 'diff_c0', t, diff_0)

				ax = pn.addAxis(ylabel = 'left-left lane c1')
				diff_1 = ABDLaneData_signals.left_left_line.c1 - CAN_signals.left_left_line.c1
				pn.addSignal2Axis(ax, 'diff_c1', t, diff_1)

				ax = pn.addAxis(ylabel = 'left-left lane c2')
				diff_2 = ABDLaneData_signals.left_left_line.c2 - CAN_signals.left_left_line.c2
				pn.addSignal2Axis(ax, 'diff_c2', t, diff_2)

				ax = pn.addAxis(ylabel = 'left-left lane c3')
				diff_3 = ABDLaneData_signals.left_left_line.c3 - CAN_signals.left_left_line.c3
				pn.addSignal2Axis(ax, 'diff_c3', t, diff_3)

				ax = pn.addAxis(ylabel = 'view range')
				diff_view_range = ABDLaneData_signals.left_left_line.view_range - CAN_signals.left_left_line.view_range
