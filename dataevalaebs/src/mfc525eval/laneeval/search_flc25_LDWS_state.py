...
class Search(iSearch):
    sgs = [
        {
            "StateOfLDWS": ("FLI2_E8_sE8_FLI2_E8_CAN22", "FLI2_LDWSState_E8"),
        },
        {
            "StateOfLDWS": ("FLI2_E8_sE8", "LaneDepartureWarningSystemState"),
        },
        {
            "StateOfLDWS": ("FLI2_E8_sE8_FLI2_E8_CAN22", "FLI2_LDWSState_E8"),
        },
        ...
        {
            "StateOfLDWS": ("FLI2_E8_CAN20", "FLI2_StateOfLDWS"),
        },
        {
            "StateOfLDWS": ("MTSI_stKBFreeze_010ms_t",
                            "MFC5xx_Device_KB_MTSI_stKBFreeze_010ms_t_sFlc25_OmLatControlMessages_FLI2_lane_departure_warning_system_state"),
        },
        {
        ...
        {
            "StateOfLDWS": ("MFC5xx Device.KB.MTSI_stKBFreeze_020ms_t",
