...
class Search(iSearch):
    ...
    def fill(self, group):
        ...
        # find intervals
        quality_25_mask = (0 <= right_quality) & (right_quality < 26)
        quality_50_mask = (25 < right_quality) & (right_quality < 51)
        quality_75_mask = (50 < right_quality) & (right_quality < 76)
        quality_100_mask = (75 < right_quality) & (right_quality < 101)
