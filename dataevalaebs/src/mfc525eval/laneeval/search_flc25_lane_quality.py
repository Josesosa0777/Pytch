...
class Search(iSearch):
    dep = {
        'Lane_quality': "calc_flc25_lane_quality@aebs.fill"
    }
    ...
    def fill(self):
        ...
        left_lane_intervals = maskToIntervals(left_lane_quality)
        ...
        for jump, left_lane_interval in zip(jumps, left_lane_intervals):
            ...
            report.vote(idx, event_votes, "left lane quality is around 50%")

        right_lane_intervals = maskToIntervals(right_lane_quality)
        ...
        for jump, right_lane_interval in zip(jumps, right_lane_intervals):
            ...
            report.vote(idx, event_votes, "right lane quality is around 50%")
